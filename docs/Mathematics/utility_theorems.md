...
Es una caracterización de una señal obtenida por medio de la serie de Fourier (Acordarme de ponerla) y la tranformada de Fourier (Igual). Estas herramientas proporcionan los medios para representar una señal como la suma de ondas sinoidales de frecuencias y amplitudes diferentes [1]. La serie de Fourier es útil para el caso especial de señales periódicas como la mostrada a continuación:
...
## Referencias
[1] A. S. Sedra y K. C. Smith, Circuitos Microelectrónicos, 4.ª ed. Oxford University Press, 1999.
