...
Figura 1. Diagrama de Bloques de una Fuente de Poder, Adaptado de [1]
...
Figura 2. Circuito de regulación de Línea básico, Adaptado de [2]
...
Figura 3. Diagrama de Conmutación, Adaptado de [3]

![Gráfica de Conmutación CC-CC](/img/power_electronic/time%20conmuting%20CC-CC.png)

Figura 4. Gráfica de salida Conmutación CC-CC, Adaptado de [3]
